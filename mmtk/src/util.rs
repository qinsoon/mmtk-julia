...
pub extern "C" fn add_object_to_mmtk_roots(obj: ObjectReference) {
    // debug_assert!(mmtk::memory_manager::is_in_mmtk_spaces::<JuliaVM>(obj));
...
pub extern "C" fn process_root_edges(_closure: &mut dyn EdgeVisitor<JuliaVMEdge>, addr: Address) {
    ...
    // {
    //     let obj = unsafe { addr.load::<ObjectReference>() };
    //     debug_assert!(obj.is_null() || mmtk::memory_manager::is_in_mmtk_spaces::<JuliaVM>(obj), "Object {} from edge {} is not in MMTK space", obj, addr);
    // }
